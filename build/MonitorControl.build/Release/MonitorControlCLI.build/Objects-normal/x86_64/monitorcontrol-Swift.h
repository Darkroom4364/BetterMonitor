...
#ifndef MONITORCONTROL_SWIFT_H
#define MONITORCONTROL_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="monitorcontrol",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14monitorcontrol12ReplyHandler")
@interface ReplyHandler : NSObject
- (void)handleReply:(NSNotification * _Nonnull)notification;
